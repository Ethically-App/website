    ...
    return (
        ...
        <section id="header" className="bg-amber-100/40 w-full mt-16 sm:mt-24 px-8 sm:px-32 xl:px-40 py-28 flex justify-center items-center flex-col-reverse lg:flex-row">
            <div className="w-full lg:w-1/2 text-center lg:text-left">
                ...
                <a href="/register" className="mulai animate fadeIn p-3 px-6 bg-amber-300 rounded-full text-white text-xl font-semibold shadow-lg hover:bg-yellow-300 hover:shadow-xl transition-all duration-300 cursor-pointer" style={{animationDelay: "0.4s"}}>Mulai<i className="ml-3 fa-solid fa-arrow-right transition-all"></i></a>
            </div>
        ...
        <section id="end" className="bg-white bg-[url('/bg.svg')] bg-[length:280%] sm:bg-[length:200%] md:bg-[length:140%] lg:bg-cover w-full px-10 lg:px-28 py-40 flex justify-center items-center flex-col text-center">
