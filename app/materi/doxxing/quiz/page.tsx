...
export default function CyberbullyingQuiz() {
  ...
  return (
    <>
      <Navigation nama={"doxxing"} back={"4"} />
      <section className="bg-[url('/bg.svg')] bg-cover bg-center relative z-[2] bg-white w-full h-full px-8 sm:px-32 xl:px-40 py-28 flex justify-start items-center flex-col">
        <div className={'p-8 pt-4 pb-10 text-center'}>
          ...
          <p className={'text-lg'}>Doxxing <span className={'text-zinc-500 font-bold'}>—</span> Soal {page} / 5</p>
        </div>
        
        {page === 1 ? (
          <>
            <br/>
            <h2 className={'text-xl md:text-2xl font-medium text-center animate fadeIn'}>Apa pengertian dari doxxing?</h2>
            <div className={'w-full max-w-screen-lg mt-8 mx-8 grid gap-4'}>
              <AnswerPrompt number={1} ref={ans1Page1}>Tindakan mengungkapkan rahasia pribadi orang secara online.</AnswerPrompt>
              <AnswerPrompt number={2} ref={ans2Page1} delay=".2s">Sebuah sikap menghargai orang lain</AnswerPrompt>
          ...
          <>
            <br/><br/>
            <h2 className={'text-xl md:text-2xl font-medium text-center animate fadeIn'}>Mengapa doxxing berbahaya?</h2>
            <div className={'w-full max-w-screen-lg mt-8 mx-8 grid gap-4'}>
              <AnswerPrompt number={1} ref={ans1Page2}>Karena dapat mengakibatkan penyalahgunaan informasi pribadi</AnswerPrompt>
              <AnswerPrompt number={2} ref={ans2Page2} delay=".2s">Karena ini adalah cara untuk memperoleh keuntungan</AnswerPrompt>
              <AnswerPrompt number={3} ref={ans3Page2} delay=".4s">Karena itu membuat seseorang terkenal di dunia maya</AnswerPrompt>
            </div>
          </>
        ) : page === 3 ? (
          <>
            <br/><br/><br/>
            <h2 className={'text-xl md:text-2xl font-medium text-center animate fadeIn'}>Bagaimana cara mencegah doxxing?</h2>
            <div className={'w-full max-w-screen-lg mt-8 mx-8 grid gap-4'}>
              <AnswerPrompt number={1} ref={ans1Page3}>Tindakan melecehkan atau merendahkan seseorang secara online.</AnswerPrompt>
              <AnswerPrompt number={2} ref={ans2Page3} delay=".2s">Menggunakan password yang mudah ditebak</AnswerPrompt>
              <AnswerPrompt number={3} ref={ans3Page3} delay=".4s">Penggunaan media sosial dengan bijak.</AnswerPrompt>
            </div>
          </>
        ) : page === 4 ? (
          <>
            <br/><br/><br/><br/>
            <h2 className={'text-xl md:text-2xl font-medium text-center animate fadeIn'}>Apa salah satu dampak dari Doxxing?</h2>
            <div className={'w-full max-w-screen-lg mt-8 mx-8 grid gap-4'}>
              <AnswerPrompt number={1} ref={ans1Page4}>Peningkatan privasi dan keamanan.</AnswerPrompt>
              <AnswerPrompt number={2} ref={ans2Page4} delay=".2s">Ancaman keselamatan dan kerugian.</AnswerPrompt>
              <AnswerPrompt number={3} ref={ans3Page4} delay=".4s">Keamanan online yang kuat.</AnswerPrompt>
            </div>
          </>
        ) : page === 5 ? (
          <>
            <br/><br/><br/><br/><br/>
            <h2 className={'text-xl md:text-2xl font-medium text-center animate fadeIn'}>Apa yang disarankan untuk dilakukan jika menjadi korban Doxxing?</h2>
            <div className={'w-full max-w-screen-lg mt-8 mx-8 grid gap-4'}>
              <AnswerPrompt number={1} ref={ans1Page5}>Balas dengan tindakan balasan online.</AnswerPrompt>
              <AnswerPrompt number={2} ref={ans2Page5} delay=".2s">Hapus informasi pribadi tanpa memberi tahu pihak berwenang.</AnswerPrompt>
              <AnswerPrompt number={3} ref={ans3Page5} delay=".4s">Laporkan ke pihak berwenang, ubah informasi identitas, dan minta dukungan.</AnswerPrompt>
            </div>
          </>
        ) : (null)}
