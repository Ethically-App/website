    ...
    <>
      ...
      <section className="bg-[url('/bg.svg')] bg-cover bg-center relative z-[2] bg-white w-full h-full px-8 sm:px-32 xl:px-40 py-28 flex justify-start items-center flex-col">
        ...
        {page === 1 ? (
          ...
          <>
            <br/><br/>
            <h2 className={'text-xl md:text-2xl font-medium text-center animate fadeIn'}>Apa saja ciri-ciri cyberbullying?</h2>
            <div className={'w-full max-w-screen-lg mt-8 mx-8 grid gap-4'}>
              <AnswerPrompt number={1} ref={ans1Page2}>Mengirim pesan ancaman, mengujarkan kebencian, menyebarkan konten mempermalukan, dan masih banyak lagi.</AnswerPrompt>
              <AnswerPrompt number={2} ref={ans2Page2} delay=".2s">Berbagi informasi positif di media sosial.</AnswerPrompt>
              <AnswerPrompt number={3} ref={ans3Page2} delay=".4s">Mengirim pesan cinta dan dukungan.</AnswerPrompt>
            </div>
          </>
        ) : page === 3 ? (
          <>
            <br/><br/><br/>
            <h2 className={'text-xl md:text-2xl font-medium text-center animate fadeIn'}>Apa dampak buruk yang bisa ditimbulkan oleh cyberbullying?</h2>
            <div className={'w-full max-w-screen-lg mt-8 mx-8 grid gap-4'}>
              <AnswerPrompt number={1} ref={ans1Page3}>Kecemasan, depresi, dan stress.</AnswerPrompt>
              <AnswerPrompt number={2} ref={ans2Page3} delay=".2s">Peningkatan harga diri.</AnswerPrompt>
              <AnswerPrompt number={3} ref={ans3Page3} delay=".4s">Perasaan bahagia dan puas.</AnswerPrompt>
            </div>
          </>
        ) : (null)}
