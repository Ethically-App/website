...
export default function Cyberbullying1() {
    return (
        ...
        <section className="relative z-[2] bg-white w-full h-full px-8 sm:px-32 xl:px-40 py-28 flex justify-start items-center flex-col-reverse lg:flex-row ">
