...
export default function Hoax3() {
    return (
        <>
        <Navigation nama={'hoax'} back={'2'} next={'4'} />
        ...
        <div className="w-full h-full lg:w-1/2 text-center lg:text-left">
            <h1 className="text-2xl md:text-3xl xl:text-[2.8rem] animate fadeInDown font-bold xl:leading-normal mb-4">Dampak Hoax</h1>
            <p className="lg:txt-lg xl:text-xl animate fadeInDown" style={{animationDelay: "0.2s"}}>
            Penyebaran hoax dapat menimbulkan dampak negatif yang serius, seperti:
            <br /><br />
            <ol className={'inline-block ml-4 lg:ml-8 list-decimal text-left'}>
                <li>Kekacauan di Masyarakat.</li>
