...
export default function BackButton({ text, simple = false, white = false, href = "", ...props } : ButtonType) {
    ...
    const whites = {
        default: 'p-2 px-6 bg-white rounded-full text-black text-lg font-medium shadow-lg hover:bg-zinc-200 hover:shadow-xl transition-all duration-300 cursor-pointer ',
